...
#                         downloadpath = normpath("/Users/papablaza/git/ARPST-CSIRO-STAGE-5/PISP-dev-pub.jl/data", "PISP-downloads"), # Path where all files from AEMO's website will be downloaded and extracted
...
#                         output_root  = normpath("/Users/papablaza/git/ARPST-CSIRO-STAGE-5/PISP-dev-pub.jl/data", "PISP-outputs"),   # Root output path where the output folder will be created
...
PISP.build_ISP24_datasets( 
                        ...
                        reftrace     = 4006,                  # Reference weather year trace: select among 2011 - 2023 or 4006 (trace for the ODP)
                        years        = [2025,2030,2031,2032],          # Calendar years for which to build the time-varying schedules: select among 2025 - 2050
                        output_name  = "out-sanity",                 # Output folder name   
